...
if ($order_id > 0) {
    ...
    $query = "UPDATE orders SET order_status = 2 WHERE id = ?";
    ...
    if ($stmt = $conn->prepare($query)) {
        ...
        if ($stmt->affected_rows > 0) {
            ...
            $_SESSION['success'] = "Order status has been marked as pending successfully.";
        } else {
...
header("Location: placed_order_list.php");
exit;
?>
