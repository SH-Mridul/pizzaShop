...
$query = "
    ...
    WHERE 
        o.order_status = 2 AND od.status = 1
";
...
<body>
  ...
  <div class="container my-4">
    <h5 class="mb-4 text-center">Pending Orders</h5>
    <div class="row">
              ...
              <div class="card shadow-sm mb-4">
                  <div class="card-body">
                      ...
                      <div class="text-center mt-3">
                          ...
                          ?>
                          <a href="mark_as_completed_order.php?order_id=<?php echo urlencode($order_id_var); ?>" class="btn btn-sm btn-success">marked as completed</a>
                      </div>
                  </div>
              </div>
          </div>
